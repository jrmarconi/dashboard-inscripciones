...
CFP N° 1 - Río Cuarto - 1993 - MCA01-TT;MECÁNICA;DIAGNÓSTICO DE CIRCUITOS ELÉCTRICOS BASE;MICROCREDENCIAL;VERDADERO;Diagnóstico de Circuitos Eléctricos Base;JEREZ MEDINA,Javier Marcelo;19-08-26;16-09-26;5;MI;15:30-18:30;2;20
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 print:mb-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 flex items-center gap-2">
            ...
            <span><span className="text-blue-600 print:text-black">CFP N°1 -</span> Inscripciones 2°C - 2026B</span>
          </h1>
